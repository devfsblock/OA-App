      ...
      <div className="flex h-full flex-col items-center justify-center space-y-8 py-12 text-center">
        ...
        >
          <h1 className="mb-4 bg-gradient-to-r from-blue-500 to-purple-600 bg-clip-text text-4xl font-bold text-transparent">
            <TextGenerateEffect words="Label Now - Coming Soon" />
          </h1>
          <p className="mb-8 text-lg text-muted-foreground">
            Our data labeling platform is under development. Stay tuned for updates on this exciting feature that will
            allow you to earn rewards by labeling data.
          </p>
        </motion.div>
